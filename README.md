...
| **Python 3.12+** | Geração de placas (Pillow) e agregação de dados |
| **Chrome API** | Storage, Tabs, Messaging, Windows |
...
├── content.js            # Injeção de filtro
├── main.py               # Geração de placas Ishihara
├── aggregate_results.py   # Agregação de resultados
├── simulate_205.py       # Simulação com 205 pessoas
├── simulate_58.py        # Simulação com 58 pessoas
...
**Versão**: 1.1 (Corrigida - Maio 2026)  
**Licença**: MIT
...
**Versão de Apresentação TCC - Maio 2026**
